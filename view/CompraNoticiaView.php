...
<main>
    ...
    <form action="./model/guardarCompra.php?id_noticia=<?php echo "$id" ?>" method="POST" enctype="application/x-www-form-urlencoded" class="w3-container" style="width: 35%">
        ...
        <input type="number" name="ano_venc" placeholder="Año de vencimiento de la tarjeta" required class="w3-input w3-border w3-light-grey w3-animate-input w3-margin" style="width: 70%">
