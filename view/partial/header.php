...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card">
        ...
        <a href="index?page=iniciarSesion" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Iniciar Sesión</a>
        <a href="index?page=contacto" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Contacto</a>
    </div>
</div>
